...
public class Shader {
    ...
    public Shader(String filepath){
        ...
        try {
            ...
            e.printStackTrace();
            assert false: "Error: Can not open file for shader: '" + filepath + "'";
        }
    }
    ...
    public void compile(){
        ...
        if (success == GL_FALSE) {
            ...
            System.out.println("\nError: " + glGetShaderInfoLog(shaderProgramID, len));
            assert false: "";
        }
    }
    ...
    public void uploadVector4f(String varName, Vector4f vector) {
        int variableLocation = glGetUniformLocation(shaderProgramID, varName);
        use();
