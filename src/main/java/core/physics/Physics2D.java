...
public class Physics2D {
    ...
    public void addBox2DCollider(Rigidbody2D rigidbody, Box2DCollider boxCollider) {
        Body body = rigidbody.getRawBody();
        assert body != null : "Raw body cannot be null";
    ...
    public RaycastInfo raycast(GameObject requestingGameObject, Vector2f point1, Vector2f point2){
        RaycastInfo callback = new RaycastInfo(requestingGameObject);
